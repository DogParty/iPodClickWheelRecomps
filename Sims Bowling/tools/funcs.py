...
DEFAULT_IMAGE = (
    PROJECT.parents[2] / "20 iPod games" / "Games_RO" / "1500C" / "Executables" / "SimsBowling_1_1_3002478.bin"
)
...
def main() -> int:
    ...
    if stored:
        functions = build_function_table(image, [], live_targets | stored, image.end, runtime_entries)
