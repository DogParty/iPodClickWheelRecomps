...
using bowling::platform::make_directory_save_store;
using bowling::platform::save_store;
using bowling::platform::SaveStore;
using bowling::platform::set_save_store;
...
int main() {
    ...
    const std::filesystem::path directory =
        std::filesystem::temp_directory_path() / "bowling-save-store-test";
