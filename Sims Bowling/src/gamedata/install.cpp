...
bool install_from_directory(const std::string& source_dir, const std::string& game_dir,
                            std::string& why) {
    // A player may hand over the `1500C` folder itself or the folder that contains it. Both are
...
std::string locate_game(platform::Platform& platform, const std::string& data_dir) {
    ...
    std::string why;
    std::string message = "Choose the game's folder (1500C), copied from your iPod";
