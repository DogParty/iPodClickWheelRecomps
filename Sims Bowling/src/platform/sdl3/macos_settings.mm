...
using bowling::platform::Action;
using bowling::platform::ACTION_COUNT;
using bowling::platform::action_label;
using bowling::platform::all_actions;
using bowling::platform::assignable_inputs;
using bowling::platform::BINDING_SLOTS;
using bowling::platform::input_bindings;
using bowling::platform::InputChoice;
using bowling::platform::InputCode;
using bowling::platform::MAX_RENDER_SCALE;
using bowling::platform::MIN_RENDER_SCALE;
using bowling::platform::NO_INPUT;
using bowling::platform::Scaling;
using bowling::platform::SCALING_COUNT;
using bowling::platform::scaling_label;
using bowling::platform::Settings;
using bowling::platform::settings;
using bowling::platform::SettingsHooks;
...
- (void)openSettings:(id)sender {
    (void)sender;
    bowling::platform::settings_window_open();
}
@end
