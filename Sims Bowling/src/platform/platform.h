...
struct FrameInput {
    ...
    // Button bits down *right now* — the level behind the edges above. The game times holds:
    // its name screen says "Hold Center to validate", and Menu held four seconds asks to leave.
