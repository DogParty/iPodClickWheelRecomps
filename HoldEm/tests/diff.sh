...
#
#   tests/diff.sh <case> [path/to/holdem-headless] [--lines=N] [--exact]
#
...
case_name=${1:?usage: tests/diff.sh <case> [holdem-headless] [--lines=N] [--exact]}
shift
binary=build/holdem-headless
limit=0
mode=""
for argument in "$@"; do
    case $argument in
