...
using holdem::platform::make_directory_save_store;
using holdem::platform::save_store;
using holdem::platform::SaveStore;
using holdem::platform::set_save_store;
...
int main() {
    ...
    const std::filesystem::path directory =
        std::filesystem::temp_directory_path() / "holdem-save-store-test";
