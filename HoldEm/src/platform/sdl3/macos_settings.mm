...
using holdem::platform::Action;
using holdem::platform::ACTION_COUNT;
using holdem::platform::action_label;
using holdem::platform::all_actions;
using holdem::platform::assignable_inputs;
using holdem::platform::BINDING_SLOTS;
using holdem::platform::input_bindings;
using holdem::platform::InputChoice;
using holdem::platform::InputCode;
using holdem::platform::MAX_RENDER_SCALE;
using holdem::platform::MIN_RENDER_SCALE;
using holdem::platform::NO_INPUT;
using holdem::platform::Scaling;
using holdem::platform::SCALING_COUNT;
using holdem::platform::scaling_label;
using holdem::platform::Settings;
using holdem::platform::settings;
using holdem::platform::SettingsHooks;
...
- (void)openSettings:(id)sender {
    (void)sender;
    holdem::platform::settings_window_open();
}
@end
