...
using cubis::platform::make_directory_save_store;
using cubis::platform::save_store;
using cubis::platform::SaveStore;
using cubis::platform::set_save_store;
...
int main() {
    ...
    const std::filesystem::path directory =
        std::filesystem::temp_directory_path() / "cubis-save-store-test";
