...
using cubis::platform::Action;
using cubis::platform::ACTION_COUNT;
using cubis::platform::action_label;
using cubis::platform::all_actions;
using cubis::platform::assignable_inputs;
using cubis::platform::BINDING_SLOTS;
using cubis::platform::input_bindings;
using cubis::platform::InputChoice;
using cubis::platform::InputCode;
using cubis::platform::MAX_RENDER_SCALE;
using cubis::platform::MIN_RENDER_SCALE;
using cubis::platform::NO_INPUT;
using cubis::platform::Scaling;
using cubis::platform::SCALING_COUNT;
using cubis::platform::scaling_label;
using cubis::platform::Settings;
using cubis::platform::settings;
using cubis::platform::SettingsHooks;
