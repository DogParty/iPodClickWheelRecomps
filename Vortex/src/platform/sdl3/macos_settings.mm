...
using vortex::platform::Action;
using vortex::platform::ACTION_COUNT;
using vortex::platform::action_label;
using vortex::platform::all_actions;
using vortex::platform::assignable_inputs;
using vortex::platform::BINDING_SLOTS;
using vortex::platform::input_bindings;
using vortex::platform::InputChoice;
using vortex::platform::InputCode;
using vortex::platform::MAX_RENDER_SCALE;
using vortex::platform::MIN_RENDER_SCALE;
using vortex::platform::NO_INPUT;
using vortex::platform::Scaling;
using vortex::platform::SCALING_COUNT;
using vortex::platform::scaling_label;
using vortex::platform::Settings;
using vortex::platform::settings;
using vortex::platform::SettingsHooks;
...
- (void)openSettings:(id)sender {
    (void)sender;
    vortex::platform::settings_window_open();
}
@end
