...
using minigolf::platform::make_directory_save_store;
using minigolf::platform::save_store;
using minigolf::platform::SaveStore;
using minigolf::platform::set_save_store;
...
int main() {
    ...
    const std::filesystem::path directory =
        std::filesystem::temp_directory_path() / "minigolf-save-store-test";
