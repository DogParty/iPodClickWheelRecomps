...
using lost::platform::make_directory_save_store;
using lost::platform::save_store;
using lost::platform::SaveStore;
using lost::platform::set_save_store;
...
int main() {
    ...
    const std::filesystem::path directory =
        std::filesystem::temp_directory_path() / "lost-save-store-test";
